...
function Labour() {
  ...
  const renderPuzzle = () => {
    ...
    return (
      ...
      <JigsawPuzzle
        imageSrc="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLobrYVbdxV0gexpGcDnBC9olsNjgjfBtmiQ&usqp=CAU"
        rows={rows}
        columns={columns}
        onSolved={() => {
          setCongratulations();
  ...
  return (
    <div className="puzzle-container">
      <div className="back-container">
                <Link to="/jigsaw" className="back-button" style={{marginLeft:'20px'}}>
      ...
      <div className="left-box">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLobrYVbdxV0gexpGcDnBC9olsNjgjfBtmiQ&usqp=CAU"
          alt="Image"
