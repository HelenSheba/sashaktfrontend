...
const FourLevel = () => {
  ...
  const size = 8; // Set maze size to 8
  ...
  const calculateScore = () => {
    if (startTime !== 0 && endTime !== 0) {
      ...
      if (adjustedTime < 15) {
        calculatedScore = 200; // Set score for time < 15 seconds
      } else if (adjustedTime < 20) {
        calculatedScore = 150; // Set score for time between 15 to 20 seconds
      } else if (adjustedTime < 25) {
        calculatedScore = 100; // Set score for time between 20 to 25 seconds
      } else if (adjustedTime < 30) {
        calculatedScore = 50; // Set score for time between 25 to 30 seconds
      } else {
        calculatedScore = 25; // Set score for time > 30 seconds
      }
  ...
  useEffect(() => {
    ...
    if (elapsedTime > 35000) { // For example, if time exceeds 35 seconds
