...
import GameEndPopup from './GameEndPopup'; // Add the correct path to your GameEndPopup component
import TimeExceededPopup from "./TimeExceededPopup"; // Add the correct path to your TimeExceededPopup component
